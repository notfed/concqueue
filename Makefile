LD=g++ -lpthread -Wall
CC=g++ -Wall
trypthread : trypthread.o Person.o Room.o Lock.o Mutex.o Thread.o Event.o DateTime.o
	$(LD) -o trypthread trypthread.o Person.o Room.o Lock.o Mutex.o Thread.o Event.o DateTime.o
